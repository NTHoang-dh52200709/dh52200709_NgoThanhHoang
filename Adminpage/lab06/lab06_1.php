...
<body>
    <h2>BÙI VẠN QUỲNH DH52201345 D22 TH03 nhóm 21 thứ tư ca 1</h2>
	<fieldset>
	...
	?>
        ...
        <div class="info">
            ...
            if ($err != "") echo $err;
                ...
                $password_sha3_256 = hash('sha3-256', $password1); // sửa lỗi tên hàm mã hóa SHA3
                ...
                // Thông tin đã được xử lý an toàn
                echo "Thông tin đã xử lý an toàn: " . htmlspecialchars($username) . "<br>";
            }
            ?>
        </div>
    <?php
